(function(){
  ...
  (function(){
    ...
    box.innerHTML='<div class="opps-box" role="dialog" aria-modal="true" aria-label="what i’m looking for">'
      ...
      +'<div class="opps-body">'
      +'<p>i want to be early again. the stage before there’s a roadmap, when the real work is figuring out what to build and whether anyone actually wants it.</p>'
      +'<p>i’ve built companies, sold one and shut another down myself, then spent two years on the investor side deciding who to back. i know that first messy stretch from every angle, and i can usually tell what’s real before the dashboard can.</p>'
      +'<p>and i <span class="hl">build, not just steer</span>. with AI, i can take a rough idea to a first version in real users’ hands on my own.</p>'
      +'<p>the role i want: a <span class="hl">founding product</span> seat, PM or product engineer, at an early team. any space if it’s a genuine 0→1, AI-native a bonus. i’m in Bengaluru, and i’ll move for the right team.</p>'
      +'</div>'
      +'<div class="opps-foot">'
