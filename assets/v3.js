(function(){
  ...
  (function(){
    ...
    box.innerHTML='<div class="opps-box" role="dialog" aria-modal="true" aria-label="what i’m looking for">'
      ...
      +'<div class="opps-body">'
      +'<p class="opps-lead">my next <span class="hl">0→1</span>. specifically:</p>'
      +'<dl class="opps-specs">'
      +'<div><dt>role</dt><dd>a <span class="hl">founding product</span> role, as a PM or product engineer. i build, not just spec.</dd></div>'
      +'<div><dt>stage</dt><dd>early. any stage if it’s a true 0→1, AI-first a bonus.</dd></div>'
      +'<div><dt>based</dt><dd><span class="hl">Bengaluru</span>, open to relocating for the right team.</dd></div>'
      +'</dl></div>'
      +'<div class="opps-foot">'
